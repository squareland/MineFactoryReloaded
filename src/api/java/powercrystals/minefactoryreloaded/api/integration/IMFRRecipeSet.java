...
public interface IMFRRecipeSet {
	...
	interface IRecipeHolder {
		 ...
		 * <p>
		 * This is only needed for special conditions within your own code.
		 * @param count The count the returned ItemStack should have
		 * @return The ItemStack for this RecipeHolder
		 */
		@Nonnull
		 ...
		 * @param input The {@link ItemStack} that will smelt into {@link #getItemStack()}
		 * @param xp    The XP value for this smelting recipe
		 */
