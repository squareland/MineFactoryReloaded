...
public class WireNode {
    ...
    public WireNode offset(EnumFacing face) {
        int nx = (part.x == AxisDirection.POSITIVE ? 1 : 0) + face.getXOffset();
        int ny = (part.y == AxisDirection.POSITIVE ? 1 : 0) + face.getYOffset();
        int nz = (part.z == AxisDirection.POSITIVE ? 1 : 0) + face.getZOffset();
