...
public abstract class PipePluggable {
     ...
     * {@link Block#canBeConnectedTo(net.minecraft.world.IBlockAccess, BlockPos, EnumFacing)}. */
    public boolean canBeConnected() {
        return false;
    }

    /** PipePluggable version of
     * {@link Block#isBlockSolid(net.minecraft.world.IBlockAccess, BlockPos, EnumFacing)} */
